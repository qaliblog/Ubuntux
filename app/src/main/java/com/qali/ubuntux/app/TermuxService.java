...
import com.qali.ubuntux.R;
import com.qali.ubuntux.app.event.SystemEventReceiver;
import com.qali.ubuntux.app.terminal.TermuxTerminalSessionActivityClient;
import com.qali.ubuntux.app.terminal.TermuxTerminalSessionServiceClient;
import com.qali.ubuntux.shared.termux.plugins.TermuxPluginUtils;
import com.qali.ubuntux.shared.data.IntentUtils;
import com.qali.ubuntux.shared.net.uri.UriUtils;
import com.qali.ubuntux.shared.errors.Errno;
import com.qali.ubuntux.shared.shell.ShellUtils;
import com.qali.ubuntux.shared.shell.command.runner.app.AppShell;
import com.qali.ubuntux.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.qali.ubuntux.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.qali.ubuntux.shared.termux.shell.TermuxShellUtils;
import com.qali.ubuntux.shared.termux.TermuxConstants;
import com.qali.ubuntux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.qali.ubuntux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.qali.ubuntux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.qali.ubuntux.shared.termux.shell.TermuxShellManager;
import com.qali.ubuntux.shared.termux.shell.command.runner.terminal.TermuxSession;
import com.qali.ubuntux.shared.termux.terminal.TermuxTerminalSessionClientBase;
import com.qali.ubuntux.shared.logger.Logger;
import com.qali.ubuntux.shared.notification.NotificationUtils;
import com.qali.ubuntux.shared.android.PermissionUtils;
import com.qali.ubuntux.shared.data.DataUtils;
...
import com.qali.ubuntux.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.qali.ubuntux.terminal.TerminalEmulator;
import com.qali.ubuntux.terminal.TerminalSession;
import com.qali.ubuntux.terminal.TerminalSessionClient;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.qali.ubuntux.shared.R.string.error_execution_cancelled))) {
